                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>Lista de todo los clientes </h4><br>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="ti-plus"></i> Agregar un nuevo cliente</button>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Ingrese el nombre" name="nombre_cliente" id="nombre_cliente">
                                </div>
                                <div class="form-group">
                                    <label>Apellido del cliente</label>
                                    <input required type="text" class="form-control" placeholder="Ingrese el Apellido" name="apellido_cliente" id="apellido_cliente">
                                </div>
                                <div class="form-group">
                                    <label>Celular del cliente</label>
                                    <input required type="text" class="form-control" placeholder="Ingrese numero de cel.." name="celular_cliente" id="celular_cliente">
                                </div>
