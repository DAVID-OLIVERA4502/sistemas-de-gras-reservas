                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>Tabla de los horarios </h4><br>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="ti-plus"></i> Agregar nuevo horario de juegos</button>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                <?php foreach ($listaHorarios as $key => $horario) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $horario['inicio_horario'] ?></td>
                                                        <td><?php echo $horario['fin_horario'] ?></td>
                                                        <td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Agregar nuevo horario de juego</h5>
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="form-group">
                                    <label>Selecione hora de inicio</label>
                                    <input required type="time" class="form-control" name="inicio_horario" id="inicio_horario">
                                </div>
                                <div class="form-group">
                                    <label>Selecione hora de fin</label>
                                    <input required type="time" class="form-control" name="fin_horario" id="fin_horario">
                                </div>
