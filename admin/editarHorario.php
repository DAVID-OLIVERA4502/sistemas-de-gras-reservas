        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li class="active"><a href="horario.php"><i class="ti-calendar"></i> Horarios</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>Editar un horario </h4><br>
                                </div>
                                <div class="card-body">

                                    <form method="POST" action="">
                                        <input type="hidden" name="id_horario" id="id_horario" value="<?php echo $id ?>">

                                        <div class="form-group">
                                            <label>Selecione hora de inicio</label>
                                            <input required type="time" class="form-control" name="inicio_horario" id="inicio_horario" value="<?php echo $inicio_horario ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Selecione hora de fin</label>
                                            <input required type="time" class="form-control" name="fin_horario" id="fin_horario" value="<?php echo $fin_horario ?>">
                                        </div>
