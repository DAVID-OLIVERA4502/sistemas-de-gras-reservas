...
<head>
    ...
    <title>Administrativo | canchas</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>Administrativo de las Canchas Deportivas </h4><br>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="ti-plus"></i> Agregar una nueva cancha</button>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover ">
                                            ...
                                            <tbody>
                                                <?php foreach ($listaCancha as $key => $cancha) : ?>
                                                    <tr>
                                                        <th scope="row"><?php echo $key + 1 ?></th>
                                                        <td><?php echo $cancha['nombre_cancha'] ?></td>
                                                        <td>
                                                            <img src="<?php echo $cancha['imagen_cancha'] ?>" alt="<?php echo $cancha['nombre_cancha'] ?>.png" width="100px">
                                                        </td>
                                                        <td><?php echo $cancha['descripcion_cancha'] ?></td>
                                                        <td><?php echo $cancha['telefono_cancha'] ?></td>
                                                        <td><?php echo $cancha['direccion_cancha'] ?></td>
                                                        <td><?php
                                                            ...
                                                            ?></td>
                                                        <td><?php echo $cancha['encargado_cancha'] ?></td>
                                                        <td>
                                                            <?php
                                                            foreach ($listaCiudad as $ciudad) {
                                                                if ($ciudad['id_ciudad'] == $cancha['id_ciudad']) {
                                                        ...
                                                        <td>
                                                            <form action="editarCanchas.php" method="POST">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Agregar una nueva cancha deportiva</h5>
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Nombre de la cancha deportiva</label>
                                            <input required type="text" class="form-control" placeholder="Ingrese el nombre" name="nombre_cancha" id="nombre_cancha">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Celular del encargado</label>
                                            <input required type="text" class="form-control" placeholder="Ingrese el nro de celular" name="telefono_cancha" id="telefono_cancha">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Ingrese la url de su imagen" name="imagen_cancha" id="imagen_cancha">
                                </div>
                                <div class="form-group">
                                    <label>Direccion del local</label>
                                    <input required type="text" class="form-control" placeholder="Ingrese direccion de la canchita" name="direccion_cancha" id="direccion_cancha">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <!--div select-->
                                        <div class="form-group">
                                            <label>Seleccione el estado del local</label>
                                            <select class="form-control" name="estado_cancha" id="estado_cancha" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Ingrese el encargado" name="encargado_cancha" id="encargado_cancha">
                                </div>

                                <div class="form-group">
                                    <label for="descripcion_cancha">Ingrese una pequeña descripcion</label>
                                    <textarea required class="form-control" id="descripcion_cancha" name="descripcion_cancha" rows="3" style="height: 90px;" placeholder="ingrese la descripcion"></textarea>
                                </div>
