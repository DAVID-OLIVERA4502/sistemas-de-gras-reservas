        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li class="active"><a href="ciudades.php"><i class="ti-pin2"></i> Ciudades</a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>Editando una ciudad </h4><br>
                                </div>
                                <div class="card-body">

                                    <form method="POST" action="">
                                        <input type="hidden" name="id_ciudad" id="id_ciudad" value="<?php echo $id ?>">

                                        <div class="form-group">
                                            <label>Nombre de la ciudad</label>
                                            <input required type="text" class="form-control" placeholder="Ingrese el nombre" name="nombre_ciudad" id="nombre_ciudad" value="<?php echo $nombre_ciudad ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Imagen(URL)</label>
                                            <input required type="text" class="form-control" placeholder="Ingrese la url de su imagen" name="imagen_ciudad" id="imagen_ciudad" value="<?php echo $imagen_ciudad ?>">
                                        </div>
                                        <div class="form-group">
                                            <label for="descripcion_ciudad">Descripcion</label>
                                            <textarea required class="form-control" id="descripcion_ciudad" name="descripcion_ciudad" rows="3" style="height: 90px;" placeholder="ingrese la descripcion..."><?php echo $descripcion_ciudad ?></textarea>
                                        </div>

                                        <button type="submit" name="accion" value="editar" class="btn btn-primary">Actualizar</button>
                                        <!--Boton Concelar-->
                                        <a href="ciudades.php" class="btn btn-danger">Cancelar</a>
