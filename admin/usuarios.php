                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Usuarios de sistema</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>Lista de todo los Usuarios de Sistema </h4><br>
                                    <!--<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="ti-plus"></i> Agregar un nuevo Usuario</button>-->
                                </div>
                                <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="form-group">
                                    <label>Nombre</label>
                                    <input required type="text" class="form-control" placeholder="Ingrese el nombre" name="nombre_ciudad" id="nombre_ciudad" value="<?php echo $id ?>">
                                </div>
                                <div class="form-group">
                                    <label>Imagen</label>
                                ...
                                <div class="form-group">
                                    <label for="descripcion_ciudad">Ingrese la Descripcion</label>
...
alerta();
function alerta() {
    toastr.info('username: admin && password: admin','El usuario y password por defecto es:',{
