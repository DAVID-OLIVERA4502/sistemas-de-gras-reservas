...
<head>
    ...
    <title>Administrativo | Documentacion</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>Documentacion </h4><br>
                                </div>
                                <div class="card-body">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <span>Ir a Front Office</span>
                                            <a name="" id="" class="btn btn-secondary" href="../home.php" role="button" target="__black">Panel del Cliente</a>
                                        </li>
                                        <li class="list-group-item">
                                            <span>Ir a Back Office</span>
                                            <a name="" id="" class="btn btn-success" href="./dashboard.php" role="button" target="__black">Panel del Administrativo</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
